			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a class="page-scroll"
						onclick="location.href = 'login.jsp';">Log In</a></li>
					<li><a class="page-scroll"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 text-center">
					...
					<p>
						<a href="mailto:kiril.petrov94@gmail.com">alexander.zorov@gmail.com</a>
					</p>
				</div>
				<div class="col-lg-4 text-center">
					<i class="fa fa-envelope-o fa-3x wow bounceIn" data-wow-delay=".1s"></i>
					<p>
						<a href="mailto:kiril.petrov94@gmail.com">kiril.petrov94@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
